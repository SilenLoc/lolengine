...
object ChampionService {
    private val championsJson: ChampionsJson = ChampionLoader.loadChampions(championsString)

    private val championsJsonList: List<ChampionJson> = championsJson.data.values.toList()
