...
data class ChampionJson(
  ...
  val info: ChampionInfoJson,

  val image: ChampionImageJson,

  val tags: List<String> = emptyList(),

  val partype: String = "",

  val stats: ChampionStatsJson
